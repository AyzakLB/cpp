...
void Bureaucrat::executeForm(AForm const & form)
{
    try {
        ...
        std::cout << getName() << " couldn't execute " << form.getName() << " because " << e.what() << ", required grade to execute is " << form.getGradeToExecute() << std::endl;
    } catch (const AForm::FormNotSigned &e) {
        std::cout << getName() << " couldn't execute " << form.getName() << " because the form is not signed." << std::endl;
